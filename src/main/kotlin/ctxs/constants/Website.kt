...
object Website {
    ...
    /** Insert your own contents of index.html here, if not CTXS's normal index.html will be used.
    ...
    /** Insert your own contents of style.css here, if not CTXS's normal style.css will be used.

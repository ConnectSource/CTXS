...
object SSL {
    ...
    /** Set this to true if you are not using a proxy, and need to use HTTPS included in CTXS.
     * CAUTION: Remember to set HTTPS_KEY_PATH and HTTPS_CHAIN_PATH to your SSL certificate. */
    const val USE_HTTPS : Boolean = false

    /** Insert your own path to the privatekey.pem SSL certificate here. If not, CTXS's default one will be used.
     * CAUTION: Remember to use the full path, and change this to YOUR DOMAIN's SSL Certificate. DO NOT LEAK THIS FILE. */
    const val HTTPS_KEY_PATH : String = "/etc/letsencrypt/live/TODO/privkey.pem"

    /** Insert your own path to the fullchain.pem SSL certificate here. If not, CTXS's default one will be used.
     * CAUTION: Remember to use the full path, and change this to YOUR DOMAIN's SSL Certificate. */
    const val HTTPS_CHAIN_PATH : String = "/etc/letsencrypt/live/TODO/fullchain.pem"
